...
checkpoint = '/home/vuong/PycharmProjects/hand-predict/checkpoint/checkpoint_ssd300_480.pth.tar'
...
if __name__ == '__main__':
    # for filename in os.listdir("/home/vuong/PycharmProjects/hand-predict/hand-sign/American Sign Language Letters.v1-v1.voc/test"):
    #     if filename.__contains__(".jpg"):
    #         img_path = os.path.join("/home/vuong/PycharmProjects/hand-predict/hand-sign/American Sign Language Letters.v1-v1.voc/test", filename)
    ...
    while(True):
        ...
        frame = detect(frame, min_score=0.6, max_overlap=0.5, top_k=1)
